            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {
                            field: 'apply', title: __('ApplyData'), table: table, formatter: Table.api.formatter.buttons, buttons: [
                                {
                                    name: "applydetail",
                                    title: function (row) {
                        ...
                        {
                            field: 'apply', title: __('Recorddata'), table: table, formatter: Table.api.formatter.buttons, buttons: [
                                {
                                    name: "recorddata",
                                    title: function (row) {
                        ...
                        {
                            field: 'comment', title: __('Commentdata'), table: table, formatter: Table.api.formatter.buttons, buttons: [
                                {
                                    name: "commentdata",
                                    title: function (row) {
